/*
From: https://codepen.io/aecend/pen/WbONyK
...
const Fluid = (function (w) {
  ...
  /*
    ...
    */
  const canvas_width = 500; //Needs to be a multiple of the resolution value below.
  const canvas_height = 500; //This too.
